...
function Riemann(startupTime, config, emitter) {
  ...
  if (this.config.transport && this.config.transport === "tcp" && this.config.reconnectInterval) {
...
Riemann.prototype.reconnectIfNeeded = function () {
  if (!this.client.tcp || !this.client.tcp.socket || this.client.tcp.socket.readyState === 'closed') {
...
Riemann.prototype.setupClient = function () {
